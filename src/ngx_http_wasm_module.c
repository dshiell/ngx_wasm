...
static char *ngx_http_wasm_content_by(ngx_conf_t *cf, ngx_command_t *cmd,
    void *conf);
...
static char *ngx_http_wasm_merge_srv_conf(ngx_conf_t *cf, void *parent,
    void *child);
...
static void *
ngx_http_wasm_create_conf(ngx_conf_t *cf)
{
...
static char *
ngx_http_wasm_merge_conf(ngx_conf_t *cf, ngx_http_wasm_conf_t *parent,
...
static ngx_int_t
ngx_http_wasm_install_content_handler(ngx_conf_t *cf)
{
...
static ngx_int_t
ngx_http_wasm_stub_send_response(ngx_http_request_t *r, ngx_str_t *body)
{
    ngx_buf_t    *b;
    ngx_chain_t   out;
...
ngx_http_wasm_content_handler(ngx_http_request_t *r)
{
    ...
    ngx_log_error(NGX_LOG_NOTICE, r->connection->log, 0,
                  ...
                  &wcf->module_path, &wcf->export_name);
