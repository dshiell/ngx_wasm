...
INITIAL_MODULE="${INITIAL_MODULE:-${ROOT_DIR}/wasm/http-guests/build/hello_world.wasm}"
RELOADED_MODULE="${RELOADED_MODULE:-${ROOT_DIR}/wasm/http-guests/src/hello_world_reload.wat}"
